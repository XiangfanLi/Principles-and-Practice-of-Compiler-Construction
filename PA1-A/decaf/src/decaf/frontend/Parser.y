...
%token LITERAL
%token IDENTIFIER	  AND    OR    STATIC  INSTANCEOF  SCOPY  SEALED  VAR  FOREACH  GUARD  ARRAY_CONCAT  ARRAY_REPEAT DEFAULT  SCOPY  SEALED
...
OCStmt			:	SCOPY '(' IDENTIFIER ',' Expr ')'
					{
						$$.stmt = new OCStmt($3.ident, $5.expr, $1.loc);
					}
