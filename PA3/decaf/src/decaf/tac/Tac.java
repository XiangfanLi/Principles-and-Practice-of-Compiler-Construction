...
public class Tac {
	...
	private Tac(Kind opc, Temp op0, List<Expr> lst) {
		this.opc = opc;
		this.op0 = op0;
		this.array = lst;
	}
	...
	public String toString() {
		...
		case ASSIGN:
			...
			/*if(op0 == null)
				System.out.println("null op0");
			if(op1.name == null)
				System.out.println("null op1 name");
			System.out.println(op0.name);
			System.out.println(op1.name);*/
			if(op0 == null)
				System.out.println("null op0");
			if(op1 == null)
				System.out.println("null op1");
		...
		case PARM:
			/*if(op0==null)
				System.out.println("null op0");
			else if(op0.name ==null)
				System.out.println("null op0 name");*/
